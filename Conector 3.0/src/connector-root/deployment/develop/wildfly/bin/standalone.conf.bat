...
set JAVA_HOME="%JBOSS_HOME%\..\jre1.8.0_151_win"
...
set "JAVA_OPTS=%JAVA_OPTS% -Dfile.encoding=UTF-8 -Dderby.system.home=%JBOSS_HOME%/derby -DuploadFolder=%JBOSS_HOME%/standalone/connector -Dconnector.integration.configLocation=%JBOSS_HOME%/standalone/configuration -Dconnector.web.configLocation=%JBOSS_HOME%/standalone/configuration"
