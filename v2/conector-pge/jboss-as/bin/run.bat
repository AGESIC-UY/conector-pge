...
set JAVA_HOME=%JBOSS_HOME%\..\java\jdk1.6_windows
set JBOSS_CLASSPATH=%JAVA_HOME%\db\lib\derby.jar
...
set JAVA_OPTS=%JAVA_OPTS% -Xms128m -Xmx512m -XX:PermSize=200M -XX:MaxPermSize=200M
