...
import uy.gub.agesic.esb.error.ConnectorMessageErrorHandler;

public class ErrorMessageAction extends ConnectorMessageErrorHandler {
	...
	public ErrorMessageAction(ConfigTree config) throws ConfigurationException, RegistryException, ActionProcessingFaultException {
