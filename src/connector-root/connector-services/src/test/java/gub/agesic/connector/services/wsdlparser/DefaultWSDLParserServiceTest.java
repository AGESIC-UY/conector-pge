...
public class DefaultWSDLParserServiceTest {
    ...
    public void testCommentXSDImportTags() throws ConnectorException, URISyntaxException, IOException {
        ...
        Path wsdlPath = Paths.get(Objects.requireNonNull(getClass().getClassLoader().getResource("wsdl-with-one-import.wsdl")).toURI());
        Path wsdlPathBackup = Paths.get(Objects.requireNonNull(getClass().getClassLoader().getResource("wsdl-with-one-import.wsdl.bak")).toURI());
    ...
    public void testCommentXSDMultipleImportTags() throws ConnectorException, URISyntaxException, IOException {
        XPathParserService xpathService = new DefaultXPathParserService();
        DefaultWSDLParserService service = new DefaultWSDLParserService(new DefaultFileManagerService("", xpathService), xpathService);
        Path wsdlPath = Paths.get(Objects.requireNonNull(getClass().getClassLoader().getResource("wsdl-with-many-import.wsdl")).toURI());
        Path wsdlPathBackup = Paths.get(Objects.requireNonNull(getClass().getClassLoader().getResource("wsdl-with-many-import.wsdl.bak")).toURI());
    ...
    public void testCommentXSDIncludeTags() throws ConnectorException, URISyntaxException, IOException {
        XPathParserService xpathService = new DefaultXPathParserService();
        DefaultWSDLParserService service = new DefaultWSDLParserService(new DefaultFileManagerService("", xpathService), xpathService);
        Path wsdlPath = Paths.get(Objects.requireNonNull(getClass().getClassLoader().getResource("wsdl-with-one-include.wsdl")).toURI());
        Path wsdlPathBackup = Paths.get(Objects.requireNonNull(getClass().getClassLoader().getResource("wsdl-with-one-include.wsdl.bak")).toURI());
